...
%\begin{figure}[h]
%\centering
% \includegraphics[width=0.5\textwidth]{Img/Procedimiento/cpfoto.png}
% \caption{Esquema del dispositivo utilizado para medir resistencia con el método de las cuatro puntas}. 
% \label{fig:CuatroPuntas}
% \end{figure}
...
%\begin{figure}[h]
% \centering
% \includegraphics[width=0.2\textwidth]{Img/Procedimiento/cpfoto.jpg}
% \caption{Dispositivo de compresión utilizado en los ensayos} 
% \label{fig:jaula}
 %\end{figure}
...
%   ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
%    \begin{subfigure}[b]{0.3\textwidth}
%        \includegraphics[width=\textwidth]{Img/Procedimiento/cpfoto.png}
%        \caption{A tiger}
%        \label{fig:tiger}
%    \end{subfigure}

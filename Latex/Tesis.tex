...
material formará martensita antes de deformarse. A temperaturas mucho más altas, el material se deformará y no transformará a martensita.
 ...
 \centering
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \label{fig:EspA}
    \end{subfigure}
  \caption{Micrografías obtenida por microscopía SEM de una fisura intergranular en el fondo de un hueco de una esponja.}
  \label{FisuraEsponja}
  \end{figure}
...
\begin{description}
\item[Método I:] Se colocó dentro de una ampolla de cuarzo aproximadamente $25 g$ de la aleación, polvo de $AlB_2$ envuelvo en papel de aluminio y una porción de 
...
\begin{center} 
\begin{tabular}{@{}llllll@{}} \toprule
Esponja & Tensión (Mpa) & $\varepsilon$ ($\%$) &  $f'=\frac{R_M}{R_A}$\\ \midrule
 0        &  -0.1   & 1.30\\
 0       &  -0.6   & 1.27 \\
 0      &  -0.50   & 1.28 \\
 2.04      &  -0.90  & 1.27\\

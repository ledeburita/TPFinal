...
%TODO Explicar como se midieron los valores de V de austenita y martensita
...
% \begin{center} 
% \begin{tabular}{@{}llll@{}} \toprule
% Carga (N) & $\varepsilon$ ($\%$) & $\frac{1}{(1+\frac{\varepsilon}{100})^2}$ & $\frac{V_M}{V_A}$ \\ \midrule
%  0        &  -0.1  & 1.00 & 1.30  \\
%  0       &  -0.6   & 1.01 & 1.27  \\
%  0      &  -0.50   & 1.01 & 1.28  \\
%  800      &  -2.60 & 1.05 & 1.21  \\
...
%  50      &  -0.90  & 1.02 & 1.27  \\
%  1200     &  -2.5  & 1.05 & 1.23  \\
%  Referencia \cite{resistencia}    & 8.00  & 1.18 & 1.73   \\
%  \bottomrule
% \end{tabular}
...
% 
  \begin{figure}% \label{fig:Clavo1}
    ...
    \end{subfigure}
        ...
        \caption{3}%Corte transversal del Clavo 1}
        \label{fig: EspR2}
    \end{subfigure}
        \begin{subfigure}{0.2\textwidth}

...
%TODO Tabla con las distintas cantidades de aleación y refinador
...
% \begin{table} \label{tab:muestras}
% \begin{center}
% \begin{tabular}{@{}llllll@{}}  \toprule
% $ Muestra $ & $Cu-Zn-Al (g)$ & $Al (g)$ & $Cu$ & $AlB_2$ & $wt\% AlB_2$  \\ \midrule
% 12.53 & 2.81  & 1.287 & -34.08&a&a\\
% 12.53 & 2.53 ($-10 \%$) & 1.287 & 25.97 & a & a\\
% 12.53 & 2.38 ($-15 \%$) & 1.287 & 87.87 & a & a\\
% 12.53 & 1.61 & 1.287 & 285.6 & a & a \\
% \bottomrule
% \end{tabular}
% \caption{En esta tabla se muestra como la variación de pequeñas cantidades de Zn puede generar grandes cambios en la $M_s$. Los datos se obtuvieron utilizando 
% la fórmula \ref{tablamuestras}}
% \end{center}
% \end{table}
...
cilíndrica por electro erosión y se realizaron ensayos de compresión. %\textbf{resultados de mañana??}
\end{itemize}
...
\begin{description}
 \item[L1B1 y L2B2:] La aleación sefundió pero no incorporó el refinador en la aleación. Además no se vio una disminución en el tamaño de grano.
 \item[L2B1 y L2B2:] en el botón uno no se incorporó el $AlB_2$. Además en el lingote quedaron pegadas las pastillas con el polvo que perdieron la aleación. El boton 2 controlamos la temperatura para que el polvo no transforme pero no paso nada nuevo.
\end{description}

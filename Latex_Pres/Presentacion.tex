...
%  \includegraphics[width=0.6\textwidth]{img/intro/memoria.jpg}
...
% 
%  \begin{equation}
%  \tau_{R}=\frac{F_{R}}{A_{R}}= \sigma cos(\lambda)cos(\phi)
% \end{equation}
% \end{frame}
...
\begin{frame}
% \includegraphics[width=0.8\textwidth]{img/intro/Trans.eps} 
...
\begin{itemize}
\alert<1,2>{\item[Método I:] Aleación $+$ $AlB_2$ papel aluminio $+$ $Cu$} 
\alert<3,4>{\item[Método II:] Aleación $+$ $AlB_2$ $\rightarrow$  prensado de pastillas}
\end{itemize}
